...
from window_2_popup_button_1 import open_popup_button2, open_popup_button1, \
    open_popup_button3  # Import the open_popup function
...
def main_window():
    ...
    def output_data_for_button2():
        open_popup_button2(entry1, entry2, output_string)  # Open the popup and pass the necessary references
    ...
    calculate_button = ttk.Button(master=input_frame, text='Calculate Att', command=output_data_for_calculate_button)
    calculate_button.pack(pady=10)

    # Additional buttons
    button1 = ttk.Button(master=input_frame, text='   Avoid fine   ', command=output_data_for_button1)
    button1.pack(pady=5)

    button2 = ttk.Button(master=input_frame, text='   Take leave  ', command=output_data_for_button2)  # Link to open the popup
    button2.pack(pady=5)

    button3 = ttk.Button(master=input_frame, text='Get Attendance', command=output_data_for_button3)
    button3.pack(pady=5)
