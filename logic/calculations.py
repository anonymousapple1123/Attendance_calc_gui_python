...
print("calculations.py : Lecture per day = ", lectures_per_day)
...
def avoid_fine(absent,total,leave_days):
    ...
    lectures_to_be_present = ((100*absent)/(100-fine_starts_from)) - total # This line solves the issue and provides the output based on the user defined values of the fine starting percentages.
